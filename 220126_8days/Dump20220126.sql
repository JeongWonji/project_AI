...
INSERT INTO `membertbl` VALUES ('hong','홍길동','서울'),('iu','아이유','부산'),('shin','신사임당','인천'),('kim','김연아','광주');
...
INSERT INTO `producttbl` VALUES ('컴퓨터',1000,'2022-01-01','삼성',5),('세탁기',2000,'2022-01-02','LG',2),('냉장고',1500,'2022-01-05','대우',4);
/*!40000 ALTER TABLE `producttbl` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `v_membertbl`
--

DROP TABLE IF EXISTS `v_membertbl`;
/*!50001 DROP VIEW IF EXISTS `v_membertbl`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `v_membertbl` AS SELECT 
 1 AS `memberName`,
 1 AS `memberAddr`*/;
SET character_set_client = @saved_cs_client;

--
-- Final view structure for view `v_membertbl`
--
...
/*!50001 VIEW `v_membertbl` AS select `membertbl`.`memberName` AS `memberName`,`membertbl`.`memberAddr` AS `memberAddr` from `membertbl` */;
...
-- Dump completed on 2022-01-26  9:38:50
